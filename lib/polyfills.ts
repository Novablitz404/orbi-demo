...
// buffer when (de)serializing Int64/Hyper XDR values. The Buffer that
// Turbopack bundles for the browser is missing the 64-bit BigInt methods.
// Fix: define them on Uint8Array.prototype via DataView.
